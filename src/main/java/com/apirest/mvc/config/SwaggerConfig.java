...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
			.select()
			.apis(RequestHandlerSelectors.basePackage("com.apirest.mvc.controller"))
	...
	private static ApiInfo apiInfo() {
		return new ApiInfoBuilder()
			.title("Template API MVC Restfull")
			.description("Template API MVC Restfull with Maven, JAVA 11 and SpringBoot 2.3.x")
			.version("1.0")
